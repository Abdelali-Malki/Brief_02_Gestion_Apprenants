...
<body>
    ...
    <ul>
      ...
      <div class="myDiv"><br>
     <h2>Modifier l'apprenant</h2> <br>
     <form action="/edit_apprenants/{{  $apprenant[0]->id  }}" method="get">
        <div class="col-sm-10 " id="inp">
            <div class="row">     
                <label for=""> Name:</label>    
                <input type="text" class="form-control" name="name" value="{{ $apprenant[0]->name }}"> <br>
            </div>
            <div class="row pt-2">     
                <label for=""> Email:</label>    
                <input type="text" class="form-control" name="email" value="{{ $apprenant[0]->email }}"><br>
            </div>
            <input type="hidden" class="form-control"  name="id_promo" value="{{ $apprenant[0]->id_promo }}">
